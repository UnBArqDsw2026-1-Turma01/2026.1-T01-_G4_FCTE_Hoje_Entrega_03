...
<p align="center"><em>Imagem de referência extraída do site <a href="https://refactoring.guru/design-patterns/strategy">Refactoring Guru - Strategy</a></em></p>
</em></p>
...
| Aluno  | Participação|
| -- | -- |
|  Arthur Guilherme Aquino Santos | Participação na criação do Diagrama, , criação do código e continuação da Documentação |
|  Tiago Lemes Teixeira | Criação da Documentação e participação na criação do Diagrama |
|  Vilmar José Fagundes | Participação na criação do Diagrama  |
...
if __name__ == "__main__":
    print("--- Cenário 1: Filtragem por Data ---")
    estrategia_data = FiltrarData(data_inicio="01/01/2026", data_fim="31/05/2026")
    noticia_contexto = Noticia(estrategia_filtragem=estrategia_data)
    
    noticia_contexto.listar_conteudo("NOT-2026")

    print("\n--- Cenário 2: Mudança Dinâmica para Filtro por Categoria ---")
    estrategia_categoria = FiltrarCategoria(categoria="Ciência e Tecnologia")
    noticia_contexto.estrategia_filtragem = estrategia_categoria
...
```
--- Cenário 1: Filtragem por Data ---
Listando conteúdo com o código: NOT-2026
Aplicando filtro por Data: de 01/01/2026 até 31/05/2026

--- Cenário 2: Mudança Dinâmica para Filtro por Categoria ---
Listando conteúdo com o código: NOT-2026
Aplicando filtro pela Categoria: Ciência e Tecnologia
```
...
| `1.3` | 20/05/2026 | Documentação do código do strategy. | [Arthur GUilherme](https://github.com/ArthurGuilher62) |  [Tiago Lemes](https://github.com/TiagoTeixeira-2005) |  21/05/2026 | Revisado e aprovado|
