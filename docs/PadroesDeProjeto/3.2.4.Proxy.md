...
<p align="center"><em>Imagem de referência extraída do site <a href="https://refactoring.guru/design-patterns/proxy">Refactoring Guru - Proxy</a></em></p>
</em></p>
...
```
[Tentativa 1 - Dados Inválidos]
Falha: email ou senha não podem ser vazios.

[Tentativa 2 - Dados Válidos]
Proxy: validações realizadas. Encaminhando ao serviço real...
```
