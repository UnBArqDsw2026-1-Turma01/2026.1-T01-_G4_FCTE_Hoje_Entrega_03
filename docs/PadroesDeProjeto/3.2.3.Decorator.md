...
|--------|------|-----------|-----------|-------------|-----------------|---------------------|
| `1.0` | 12/05/2026 | Criação do documento. | [Tiago Lemes](https://github.com/TiagoTeixeira-2005) | [Kauã Vale Leão](https://github.com/KauaVL) | 19/05/2026 | Documento criado corretamente |
| `1.1` | 19/05/2026 | Preenchimento da Visão Geral, Aplicabilidade, Prós, Contras, Implementação (Senso Crítico, Diagrama, Código) e Referências. | [Kauã Vale Leão](https://github.com/KauaVL) e [Arthur Henrique Vieira](https://github.com/arthurhvieira1) |  [Tiago Lemes](https://github.com/TiagoTeixeira-2005) |  20/05/2026 | Revisado e aprovado|
